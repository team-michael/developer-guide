...
2. 노티플라이는 AWS의 Kinesis 라는 서비스를 활용하여 Amplitude와 연동을 제공하고 있습니다. Event Streaming 섹션에서 Kinesis Data Stream을 선택해 주세요. ![Amplitude data destinations](/images/ko/user-guide/amplitude/ko/assets/images/amplitude_data_destinations-60182ba205f07c4ed79d3f0d2d4aeccf.png)
...
![Amplitude destination settings](/images/ko/user-guide/amplitude/ko/assets/images/amplitude_destination_settings-d00780a051d32ec810b6ec58c2008dc0.png)
...
![Verify Kinesis Destnation Setup](/images/ko/user-guide/amplitude/ko/assets/images/verify_kinesis_destination_setup-f6176fcb21dca837dba960d90e212018.png)
...
![Amplitude project settings](/images/ko/user-guide/amplitude/ko/assets/images/amplitude_project_settings-8cd48772e239dc6f72d41307ad07eaed.png)

4. Notifly 제품에서 설정 (프로젝트 설정) - 외부 툴 연동 정보에 Amplitude 연동 정보에 위에 복사한 project\_id를 입력합니다.

![Notifly Amplitude info](/images/ko/user-guide/amplitude/ko/assets/images/notifly_amplitude_info-630d060db4de72151c91195da041ca7e.png)

## 3. 최종 확인[​](#3-최종-확인 "3. 최종 확인에 대한 직접 링크")

위 스텝들을 모두 완료하시면 `amplitude__` 로 시작되는 이벤트들을 노티플라이에서 확인하실 수 있습니다.

![Verify Notifly Amplitude integration](/images/ko/user-guide/amplitude/ko/assets/images/verify_amplitude_integration_end_to_end-75fadc9fefe56371b3a16627e1cb157a.png)
