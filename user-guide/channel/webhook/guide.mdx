...
## Webhook이란?[​](#webhook이란 "Webhook이란?에 대한 직접 링크")

### 폴링 (Polling)과 웹훅 (Webhook)[​](#폴링-polling과-웹훅-webhook "폴링 (Polling)과 웹훅 (Webhook)에 대한 직접 링크")
...
### Notifly에서의 웹훅[​](#notifly에서의-웹훅 "Notifly에서의 웹훅에 대한 직접 링크")
...
## Prerequisites[​](#prerequisites "Prerequisites에 대한 직접 링크")
...
## 웹훅 캠페인 생성 및 메시지 개인화[​](#웹훅-캠페인-생성-및-메시지-개인화 "웹훅 캠페인 생성 및 메시지 개인화에 대한 직접 링크")

### 웹훅 캠페인 생성[​](#웹훅-캠페인-생성 "웹훅 캠페인 생성에 대한 직접 링크")
...
### 메시지 개인화[​](#메시지-개인화 "메시지 개인화에 대한 직접 링크")
...
### 메시지 개인화 테스트[​](#메시지-개인화-테스트 "메시지 개인화 테스트에 대한 직접 링크")
