...
![Build Webhook Campaign - 1](/images/ko/user-guide/webhook/ko/assets/images/webhook-message-1-bc786b2acf0948f309a75a3e2f9e7dae.png)
...
![Test Webhook Campaign - 1](/images/ko/user-guide/webhook/ko/assets/images/webhook-test-1-5aead313d711a7c244ae2432d3b61c66.png)

* 발송할 유저 아이디를 입력하신 후, '테스트 발송'을 클릭해주세요.

![Test Webhook Campaign - 2](/images/ko/user-guide/webhook/ko/assets/images/webhook-test-2-f5eca992d45dfacf6e0a38198116b220.png)

* 발송 결과를 탭하시면, 더 자세한 정보를 확인하실 수 있습니다.

![Test Webhook Campaign - 3](/images/ko/user-guide/webhook/ko/assets/images/webhook-test-3-67a5c6146f231c8169786f5d94050835.png)
