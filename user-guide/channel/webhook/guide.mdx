...
웹훅 캠페인은 개인화와 함께 사용하셔야 더욱 의미있는 결과를 얻을 수 있습니다. 웹훅 캠페인을 생성하기 위해서는 다음과 같은 정보를 입력해야 합니다. 메시지 개인화에 대한 자세한 정보는 [메시지 개인화](/user-guide/campaigns/personalization) 섹션을 참고해주세요.

![Build Webhook Campaign - 1](/user-guide/images/user-guide/webhook/ko/assets/images/webhook-message-1-bc786b2acf0948f309a75a3e2f9e7dae.png)
...
![Test Webhook Campaign - 1](/user-guide/images/user-guide/webhook/ko/assets/images/webhook-test-1-5aead313d711a7c244ae2432d3b61c66.png)

* 발송할 유저 아이디를 입력하신 후, '테스트 발송'을 클릭해주세요.

![Test Webhook Campaign - 2](/user-guide/images/user-guide/webhook/ko/assets/images/webhook-test-2-f5eca992d45dfacf6e0a38198116b220.png)

* 발송 결과를 탭하시면, 더 자세한 정보를 확인하실 수 있습니다.

![Test Webhook Campaign - 3](/user-guide/images/user-guide/webhook/ko/assets/images/webhook-test-3-67a5c6146f231c8169786f5d94050835.png)
