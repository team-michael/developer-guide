---
title: "시작하기"
description: "노티플라이 캠페인을 이용하여 하여, 에 로 보내보세요. 노티플라이 캠페인 생성 페이지에서 캠페인을 쉽고 빠르게 생성할 수 있습니다."
---

## 1. 기본 정보 및 채널[​](#campaign-basic-info "1. 기본 정보 및 채널에 대한 직접 링크")
...
* **발송 채널**: 푸시, 카카오, 팝업, 메시지 등 발송할 채널을 선택합니다.
  <Warning>
    ...
    * 채널 별로 발신자 정보를 등록하는 방법은 각 채널 가이드에서 확인해주세요: [앱 푸시](/ko/user-guide/app-push-notification/guide), [웹 푸시](/ko/user-guide/web-push-notification/guide), [인앱 팝업](/ko/user-guide/in-app-message/guide), [웹 팝업](/ko/user-guide/web-message/guide), [이메일](/ko/user-guide/email/guide), [문자](/ko/user-guide/text-message/notifly_guide), [카카오톡](/ko/user-guide/kakaotalk/setup), [웹훅](/ko/user-guide/webhook/guide)
  </Warning>

## 2. 발송 시점[​](#2-발송-시점 "2. 발송 시점에 대한 직접 링크")
...
### 2.1. 예약 발송[​](#21-예약-발송 "2.1. 예약 발송에 대한 직접 링크")
...
### 2.2. 이벤트 기반 발송[​](#22-이벤트-기반-발송 "2.2. 이벤트 기반 발송에 대한 직접 링크")
...
### 2.3. API 기반 발송[​](#23-api-기반-발송 "2.3. API 기반 발송에 대한 직접 링크")
...
## 3. 캠페인 발송 대상 설정[​](#3-캠페인-발송-대상-설정 "3. 캠페인 발송 대상 설정에 대한 직접 링크")

노티플라이 캠페인은 쉽고 빠르게 타겟 사용자에게 메시지를 발송할 수 있습니다. 자세한 정보는 [캠페인 발송 대상 설정](/ko/user-guide/campaigns/campaign-segments/segment) 가이드를 확인해주세요.

## 4. 메시지 및 액션[​](#4-메시지-및-액션 "4. 메시지 및 액션에 대한 직접 링크")

채널 별 메시지 내용 및 액션 설정 방법은 각 채널에 대한 가이드를 참고해 주세요.

## 5. 성과 분석 구성 (선택 사항)[​](#analytics "5. 성과 분석 구성 (선택 사항)에 대한 직접 링크")
