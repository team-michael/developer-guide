...
![Campaign basic info creation](/images/ko/user-guide/campaigns/ko/assets/images/campaign_basic_info_creation_v2-0cfd811a9221dbb35f71f78d4025f628.png)
...
![Campaign Reservation](/images/ko/user-guide/campaigns/ko/assets/images/campaign_reservation-b317d5d0a96a0c850302170dad4ef6db.png) 노티플라이 캠페인은 선택한 시간에 원하는 유저들에게 알림을 발송할 수 있는 기능을 지원합니다. 예약 발송은 네 가지 타이밍을 지원합니다.
...
![Event based campaign - Triggering event 1](/images/ko/user-guide/campaigns/ko/assets/images/campaign_event_based_timing_v5-9c810b1b14e7b1191392874a8fb90433.png)
  ...
  * **발송 시점 결정 이벤트 추가 필터링**: 특정 이벤트에 *이벤트 파라미터*가 포함되어 발생한다면, 해당 파라미터 값을 이용하여 발송 시점을 결정하는 고도화된 필터링을 설정할 수 있습니다.
    ...
    * ex) `main_button_click` 이벤트에 `menu`라는 이벤트 파라미터가 포함되어 발생한다면, `menu`가 `trial_click`인 경우에만 캠페인을 발송합니다.
    ...
    <Accordion title="이벤트 파라미터 필터링 예시 더 보기">
      ![](/images/ko/user-guide/campaigns/ko/assets/images/triggering-event-filters-example-1-0ef9ca99f8b3291881f792ffbc801083.png)
      ...
      **AND/OR 조건**을 이용하여 더 복잡한 필터링을 설정해 보세요.
      ...
      ![](/images/ko/user-guide/campaigns/ko/assets/images/triggering-event-filters-example-2-85907e6f63211f4242f2cb3700e54d73.png)
...
<Accordion title="API 기반 발송 캠페인 생성 예시 더 보기">
  ...
  ![api-triggered-campaign-message-example](/images/ko/user-guide/campaigns/ko/assets/images/api_triggered_campaign_message_example-a1aff10c26bf6bea9409e30bc0815ce8.png)
