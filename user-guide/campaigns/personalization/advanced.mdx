...
## 1. Connected Content 이해하기[​](#1-connected-content-이해하기 "1. Connected Content 이해하기에 대한 직접 링크")

### Connected Content란 무엇인가요?[​](#connected-content란-무엇인가요 "Connected Content란 무엇인가요?에 대한 직접 링크")
...
### 주요 활용 사례[​](#주요-활용-사례 "주요 활용 사례에 대한 직접 링크")
...
### 지원 채널[​](#지원-채널 "지원 채널에 대한 직접 링크")

* 현재 **앱푸시(App Push)** 채널에서만 지원합니다.

### 사용 가능 항목[​](#사용-가능-항목 "사용 가능 항목에 대한 직접 링크")
...
### 장점 및 유의사항[​](#장점-및-유의사항 "장점 및 유의사항에 대한 직접 링크")
...
## 2. Connected Content 설정 방법[​](#2-connected-content-설정-방법 "2. Connected Content 설정 방법에 대한 직접 링크")

노티플라이에서 Connected Content를 활용하기 위한 기본적인 설정 방법을 설명합니다.

### 필요한 구성 요소[​](#필요한-구성-요소 "필요한 구성 요소에 대한 직접 링크")
...
### API 호출 예시[​](#api-호출-예시 "API 호�출 예시에 대한 직접 링크")
...
### 메시지 내에서 데이터 사용하기[​](#메시지-내에서-데이터-사용하기 "메시지 내에서 데이터 사용하기에 대한 직접 링크")
...
## 3. 옵션과 사용법 상세 안내[​](#3-옵션과-사용법-상세-안내 "3. 옵션과 사용법 상세 안내에 대한 직접 링크")

### 기본 구문[​](#기본-구문 "기본 구문에 대한 직접 링크")
...
### 에러 처리 및 성능 최적화[​](#에러-처리-및-성능-최적화 "에러 처리 및 성능 최적화에 대한 직접 링크")
...
### 고급 활용 사례[​](#고급-활용-사례 "고급 활용 사례에 대한 직접 링크")

API에서 가져온 데이터를 Liquid 템플릿으로 더 세밀하게 처리하고 싶은 경우, 조건문이나 반복문을 사용하여 데이터를 다양하게 변형시킬 수 있습니다.

```
{% connected_content https://api.example.com/products :save products %}{% for product in products.items %}  - {{ product.name }} 가격: {{ product.price }}{% endfor %}
```

이 예시에서는 제품 목록을 가져와 각 제품의 이름과 가격을 메시지에 표시합니다.

## 4. 캠페인 실행 및 모니터링[​](#4-캠페인-실행-및-모니터링 "4. 캠페인 실행 및 모니터링에 대한 직접 링크")

### 캠페인 기획[​](#캠페인-기획 "캠페인 기획에 대한 직접 링크")

* **목적 정의**: 메시지에서 외부 데이터를 사용하는 목적을 명확히 합니다.
* **데이터 요구사항 분석**: 필요한 데이터와 해당 데이터를 제공할 수 있는 API를 확인합니다.

### 개발 및 테스트[​](#개발-및-테스트 "개발 및 테스트에 대한 직접 링크")
