...
![random bucket in user list](/images/ko/user-guide/campaigns/campaign-segments/ko/assets/images/user_list_random_bucket_number-358f20bdf353aee3abaaa355fb39bd97.png)
...
* 예시: 새로운 캠페인을 진행하기 전, 10%의 유저에게 먼저 캠페인을 진행해보고 캠페인의 효과를 확인한 후 나머지 90%의 유저에게 캠페인을 진행합니다.
  ...
  * 캠페인 A를 먼저 집행해본 후, 캠페인 B를 노출시킴으로써 점진적으로 캠페인 대상을 늘려갈 수 있습니다.
  ...
  ![random bucket number 1](/images/ko/user-guide/campaigns/campaign-segments/ko/assets/images/campaign_segment_random_bucket_number_pre-ef4d01b6efbf924ef3143bbba4fed9fe.png)![random bucket number 1](/images/ko/user-guide/campaigns/campaign-segments/ko/assets/images/campaign_segment_random_bucket_number_main-4038bd5112cb87c5a48eda368b57fa0c.png)
