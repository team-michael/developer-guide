...
---
  ...
  Notifly  SDK에서는 인앱 팝업에서 발생하는 이벤트를 감지하고 처리할 수 있는 이벤트 리스너를 제공합니다. 이를 통해 인앱 팝업에서 사용자가 특정 행동을 했을 때, 추가적인 행동을 앱에서 처리할 수 있습니다.
...
<Tab title="Flutter"> 
  ...
  <Info> 해당 기능은 Notifly Flutter SDK 2.1.0 이상 버전부터 지원됩니다.</Info>
...
<ParamField path="eventName" type="field name"> 발생한 이벤트의 이름입니다. </ParamField>
<ParamField path="eventParams" type="field name"> 발생한 이벤트와 관련된 추가 정보가 포함된 객체입니다. </ParamField>
</Tab>
</Tabs>
