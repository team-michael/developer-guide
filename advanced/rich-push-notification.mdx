...
![Add Push Extension](/developer-guide/image/ios_push_extension_open_project_navigator.png)

2. Project Navigator에서 프로젝트를 선택한 후 + 버튼을 눌러 Notification Service Extension을 추가합니다.

![Add Push Extension](/developer-guide/image/ios_push_extension_create_extension_target.png)

3. Product Name을 `NotiflyNotificationExtension`으로 지정하고 Finish를 클릭합니다.

![Add Push Extension](/developer-guide/image/ios_generate_push_extension.png)

생성된 Extension의 버전이 메인 앱과 동일한지 확인합니다.

![Push Extension App Version](/developer-guide/image/ios_push_extension_version.png)
...
![Main App Group](/developer-guide/image/ios_push_extension_app_group1.png)
...
[SDK 연동 테스트](/integration-test) 참고하여 진행합니다.
...
![Add Push Extension](/developer-guide/image/ios_push_delivered.png)
