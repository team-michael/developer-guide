...
웹훅 캠페인은 개인화와 함께 사용하셔야 더욱 의미있는 결과를 얻을 수 있습니다. 웹훅 캠페인을 생성하기 위해서는 다음과 같은 정보를 입력해야 합니다. 메시지 개인화에 대한 자세한 정보는 [메시지 개인화](/ko/user-guide/campaigns/personalization) 섹션을 참고해주세요.
