...
![Add Push Extension](/ko/developer-guide/image/ios_push_extension_open_project_navigator.png)

2. Project Navigator에서 프로젝트를 선택한 후 + 버튼을 눌러 Notification Service Extension을 추가합니다.

![Add Push Extension](/ko/developer-guide/image/ios_push_extension_create_extension_target.png)

3. Product Name을 `NotiflyNotificationExtension`으로 지정하고 Finish를 클릭합니다.

![Add Push Extension](/ko/developer-guide/image/ios_generate_push_extension.png)

생성된 Extension의 버전이 메인 앱과 동일한지 확인합니다.

![Push Extension App Version](/ko/developer-guide/image/ios_push_extension_version.png)

## 2. App Groups 설정

1. 그룹 ID는 `group.notifly.{username}` 형식을 사용합니다. (username은 노티플라이 콘솔의 SDK 인증 정보에서 확인 가능)
...
![Main App Group](/ko/developer-guide/image/ios_push_extension_app_group1.png)
...
노티플라이 SDK를 Extension Target에 static 라이브러리로 설치해야 합니다.
...
[SDK 연동 테스트](/ko/integration-test) 참고하여 진행합니다.
...
![Add Push Extension](/ko/developer-guide/image/ios_push_delivered.png)
