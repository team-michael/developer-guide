...
4. 태그 구성에서 Tag Type: SDK 초기화 선택 후 Project ID, Username, Password 입력. ([노티플라이 SDK 초기화 옵션](/sdk/javascript-sdk#2-sdk-%EC%B4%88%EA%B8%B0%ED%99%94) 참고.)
...
- [JavaScript SDK 가이드의 웹 푸시 설정 섹션](/sdk/javascript-sdk#1-%EA%B8%B0%EB%B3%B8-%EC%84%A4%EC%A0%95)을 참고하여 사이트에 `notifly-service-worker.js` 파일을 추가해주세요.
